        ...
        try:
            ...
            if form.is_valid():
                ...
                try:
                    ...
                    notification(id_customer.user_id.pk, "Coupon Purchase", notification_body, "alwafacustomer")
                except Exception as e:
...
class NewRequestHome(View):
    ...
    #                 notification_customer(sales_man.pk, "New Request", "A new request has been created.", "alwafacustomer")
            ...
            if form.is_valid():
                ...
                if customer.sales_staff:
                    ...
                    try:
                        ...
                        notification(sales_man.pk, "New Water Request", salesman_body, "alwafa")
